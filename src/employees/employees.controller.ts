...
export class EmployeesController {
  ...
  async create(
    ...
    if (!file) {
      ...
      createEmployeeDto.employeePhoto = String(photoURL);
      return this.employeesService.create(createEmployeeDto);
    }
  }
  ...
  @ApiResponse({
    ...
    example: {
      message:
        "This route return the specific employee with the corresponding ID",
    },
  })
  @Get(":id")
  ...
  @ApiResponse({
    ...
    example: {
      message:
        "This route update the specific employee with the corresponding ID",
    },
  })
  @Patch("/:id")
  async update(
